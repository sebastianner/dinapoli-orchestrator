...
export function Sidebar() {
  ...
  const markSwitchIntent = useSessionStore((s) => s.markSwitchIntent);
    ...
    <>
      ...
      <aside className="hidden h-full w-20 shrink-0 flex-col items-center justify-between border-r border-border bg-surface py-4 sm:w-24 md:flex">
        <nav className="flex flex-col items-center gap-2">
          ...
          >
            ...
            <span className="text-center text-[11px] font-medium leading-tight">Empleado</span>
          </Link>
      ...
      >
        ...
        >
          ...
          <span className="text-center text-[10px] font-medium leading-tight">Empleado</span>
        </Link>
